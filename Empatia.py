...
# HATA ENGELLEYİCİ: Eğer eski db kalmışsa otomatik sütun ekle
try:
...
varsayilan_avatar = "https://www.w3schools.com/howto/img_avatar.png"
avatar_resmi = varsayilan_avatar

if res and res[0] and os.path.exists(res[0]):
    try:
        with Image.open(res[0]) as img:
            img.verify()
        avatar_resmi = res[0]
    except Exception:
        avatar_resmi = varsayilan_avatar
...
with st.sidebar:
    ...
    try:
        ...
        st.image(varsayilan_avatar, width=70)
    ...
    if uploaded_file is not None:
        ...
        try:
            ...
            st.error("Görsel yüklenirken bir hata oluştu.")
